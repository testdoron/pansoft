...
namespace CSUST.Net
{
    ...
    #region TSqlServerBase TOleDatabaseBase
    ...
    #region ISessionEvent IDatabaseEvent
    ...
    #region TExceptionEventArgs TSessionEventArgs TSessionExceptionEventArgs
    ...
    #region enum TDisconnectType TSessionState
    ...
    public enum TSessionState
    {
        ...
        Active,    // 
        /// <summary>
        /// session is inactive and will be closed
        /// </summary>
        Inactive,  // 
        /// <summary>
        /// session is shutdownling
        /// </summary>
        Shutdown,  // 
        /// <summary>
        /// session is closed
