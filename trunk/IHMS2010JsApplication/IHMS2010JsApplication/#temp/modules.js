...
ihmsModule.TabWindow = Ext.extend(Ext.app.Module, {
    id:'tab-win',
    init : function(){
        this.launcher = {
            text: 'Tab Window',
...
ihmsModule.AccordionWindow = Ext.extend(Ext.app.Module, {
    id:'acc-win',
    init : function(){
        this.launcher = {
...
ihmsModule.BogusModule = Ext.extend(Ext.app.Module, {
    init : function(){
        this.launcher = {
...
ihmsModule.BogusMenuModule = Ext.extend(ihmsModule.BogusModule, {
    init : function(){
        this.launcher = {
            text: 'Bogus Submenu',
            iconCls: 'bogus',
